...
namespace WebApplication1
{
    public partial class question : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            con1.Open();
            SqlCommand cmd1 = new SqlCommand("select * from tbl_question where question_name='" + txtquestion.Text + "'", con1);
            ...
            else
            {
                ...
                con.Open();
                SqlCommand cmd2 = new SqlCommand("insert into tbl_question(question_name)values('" + txtquestion.Text + "')", con);
