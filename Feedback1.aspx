<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="Feedback1.aspx.cs" Inherits="WebApplication1.Feedback1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table class="auto-style1">
        <tr>
            <td class="auto-style3">Subject code:<asp:DropDownList ID="ddlsubject1" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlsubject1_SelectedIndexChanged">
                </asp:DropDownList>
            </td>
            <td>&nbsp;</td>
        </tr>
