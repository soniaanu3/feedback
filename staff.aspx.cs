...
namespace WebApplication1
{
    public partial class staff : System.Web.UI.Page
    {
        ...
        protected void SUBMIT_Click(object sender, EventArgs e)
        {
            ...
            con1.Open();
            SqlCommand cmd1 = new SqlCommand("select * from tbl_staff where staff_name='" + txtstaff.Text + "'", con1);
            ...
            else
            {
                ...
                con.Open();
                SqlCommand cmd2 = new SqlCommand("insert into tbl_staff(staff_name)values('" + txtstaff.Text + "')", con);
